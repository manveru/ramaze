...
============================================================}
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<innate>, ["= 2010.01"])
      ...
      s.add_development_dependency(%q<haml>, ["= 2.2.16"])
      ...
      s.add_development_dependency(%q<memcache-client>, ["= 1.7.7"])
      s.add_development_dependency(%q<mustache>, ["= 0.5.1"])
      s.add_development_dependency(%q<mutter>, ["= 0.5.2"])
      s.add_development_dependency(%q<nagoro>, ["= 2009.05"])
      s.add_development_dependency(%q<polyglot>, ["= 0.2.9"])
      ...
      s.add_development_dependency(%q<slippers>, ["= 0.0.13"])
      ...
      s.add_development_dependency(%q<treetop>, ["= 1.4.3"])
    else
      s.add_dependency(%q<innate>, ["= 2010.01"])
      ...
      s.add_dependency(%q<memcache-client>, ["= 1.7.7"])
      s.add_dependency(%q<mustache>, ["= 0.5.1"])
      ...
      s.add_dependency(%q<slippers>, ["= 0.0.13"])
